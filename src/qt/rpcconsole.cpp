                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSmncPathCustom = GetArg("-zsmncbackuppath", "");
    ...
    if(!strzSmncPathCustom.empty()) {
        ui->wallet_customzsmncbackuppath->setText(QString::fromStdString(strzSmncPathCustom));
        ui->wallet_customzsmncbackuppath_label->setVisible(true);
        ui->wallet_customzsmncbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSmncPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the SIMPLEMASTERNODE RPC console.") + "<br>" +
