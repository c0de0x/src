...
#include "qt/smnc/forms/ui_coldstakingwidget.h"
#include "qt/smnc/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/smnc/requestdialog.h"
#include "qt/smnc/tooltipmenu.h"
#include "qt/smnc/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(SIMPLEMASTERNODEGUI* parent) :
    PWidget(parent),
    ui(new Ui::ColdStakingWidget)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your Smncs and let a hot node (24/7 online node)\nstake in your behalf, keeping the keys in a secure place offline."));
    ...
    ui->labelSubtitle2->setText(tr("Delegate or Accept Smnc delegation"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select Smnc outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 Smnc" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
