...
extern bool fGlobalUnlockSpendCache; // Bool used for letting the precomputing thread know that zsmncspends need to use the cs_spendcache
...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 Smnc at the same time
...
public:
    ...
    std::string GetUniqueWalletBackupName(bool fzsmncAuto) const;
    ...
    */
    ...
    CzSmncWallet* getZWallet();
    bool isZeromintEnabled();
    void setZSMNCAutoBackups(bool fEnabled);
    ...
    /// Get 10000 Smnc output and keys which can be used for the Masternode
