...
class PWidget : public QWidget, public Runnable
{
    Q_OBJECT
public:
    explicit PWidget(SIMPLEMASTERNODEGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    SIMPLEMASTERNODEGUI* getWindow() { return this->window; }
...
protected:
    SIMPLEMASTERNODEGUI* window = nullptr;
