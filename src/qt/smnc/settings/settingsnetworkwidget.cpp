...
#include "qt/smnc/settings/settingsnetworkwidget.h"
#include "qt/smnc/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/smnc/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(SIMPLEMASTERNODEGUI* _window, QWidget *parent) :
