...
#include "qt/smnc/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/smnc/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(SIMPLEMASTERNODEGUI* _window, QWidget *parent) :
