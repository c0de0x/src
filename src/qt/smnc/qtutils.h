...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, SIMPLEMASTERNODEGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, SIMPLEMASTERNODEGUI *gui, double posX = 3);
