...
#include "qt/smnc/sendcustomfeedialog.h"
...
public:
    explicit SendWidget(SIMPLEMASTERNODEGUI* parent);
    ~SendWidget();
...
private slots:
    void onSmncSelected(bool _isSmnc);
    void onSendClicked();
...
private:
    ...
    bool sendZsmnc(QList<SendCoinsRecipient> recipients);
