...
#ifndef FURSZY_SIMPLEMASTERNODE_GUITRANSACTIONSUTILS_H
#define FURSZY_SIMPLEMASTERNODE_GUITRANSACTIONSUTILS_H
...
#endif //FURSZY_SIMPLEMASTERNODE_GUITRANSACTIONSUTILS_H
