...
#include "qt/smnc/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/smnc/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(SIMPLEMASTERNODEGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to SIMPLEMASTERNODEGUI::handleRestart()
