...
#include "qt/smnc/coincontrolsmncwidget.h"
#include "qt/smnc/forms/ui_coincontrolsmncwidget.h"

CoinControlSMNCWidget::CoinControlSMNCWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlSMNCWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select Smnc Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("Smnc");
    ...
    ui->labelValueAfter->setText("0.00 Smnc");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 Smnc");
    ui->labelValueFee->setText("0.00 Smnc");
...
CoinControlSMNCWidget::~CoinControlSMNCWidget()
{
    delete ui;
}
