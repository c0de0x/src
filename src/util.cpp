...
// SIMPLEMASTERNODE only features
// Masternode
...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL) {
        ...
        if (ptrCategory.get() == NULL) {
            ...
            // "smnc" is a composite category enabling all SIMPLEMASTERNODE-related debug output
            if (ptrCategory->count(std::string("smnc"))) {
...
// Windows < Vista: C:\Documents and Settings\Username\Application Data\SIMPLEMASTERNODE
// Windows >= Vista: C:\Users\Username\AppData\Roaming\SIMPLEMASTERNODE
// Mac: ~/Library/Application Support/SIMPLEMASTERNODE
// Unix: ~/.smnc
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "SIMPLEMASTERNODE";
#else
    fs::path pathRet;
    ...
    return pathRet / "SIMPLEMASTERNODE";
#else
    // Unix
    return pathRet / ".smnc";
#endif
