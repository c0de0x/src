Contributing to SMNC Coin
============================

The SMNC Coin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/SimpleMasternode/smnc/blob/master/doc/translation_process.md)
...
The following applies to code changes to the SMNC Coin project, and is not to be
confused with overall SIMPLEMASTERNODE Network Protocol consensus changes.

Whether a pull request is merged into SMNC Coin rests with the project merge
...
Patches that change SIMPLEMASTERNODE consensus rules are considerably more involved than
...
Where a patchset proposes to change the SIMPLEMASTERNODE consensus, it must have been
...
The project leader is the release manager for each SMNC Coin release.
