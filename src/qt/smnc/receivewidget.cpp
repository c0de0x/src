...
#include "qt/smnc/forms/ui_receivewidget.h"
...
#include "qt/smnc/addressholder.h"
...
ReceiveWidget::ReceiveWidget(SIMPLEMASTERNODEGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive Smnc."));
