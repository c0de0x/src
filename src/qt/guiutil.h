...
/** Utility functions used by the SIMPLEMASTERNODE Qt UI.
 */
namespace GUIUtil
{
...
// Render SIMPLEMASTERNODE addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZsmnc = false);
