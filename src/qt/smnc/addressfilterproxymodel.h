...
#ifndef SIMPLEMASTERNODE_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define SIMPLEMASTERNODE_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //SIMPLEMASTERNODE_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
