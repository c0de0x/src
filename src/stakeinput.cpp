...
bool CZSMNCStake::GetModifier(uint64_t& nStakeModifier)
{
    ...
    // zSmnc staking is disabled long before block v7 (and checkpoint is not included in blocks since v7)
...
bool CZSMNCStake::CreateTxOuts(CWallet* pwallet, std::vector<CTxOut>& vout, CAmount nTotal)
{
...
bool CSMNCStake::CreateTxOuts(CWallet* pwallet, std::vector<CTxOut>& vout, CAmount nTotal)
{
