...
#ifndef SIMPLEMASTERNODE_ZSmncTRACKER_H
#define SIMPLEMASTERNODE_ZSmncTRACKER_H
...
public:
    ...
    ~CzSmncTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzSmncWallet* zSmncWallet = NULL);
...
#endif //SIMPLEMASTERNODE_ZSmncTRACKER_H
