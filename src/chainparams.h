 ...
 * SIMPLEMASTERNODE system. There are three: the main network on which people trade goods
...
public:
    ...
    int SimpleMasternodeBadBlockTime() const { return nSimpleMasternodeBadBlockTime; }
    int SimpleMasternodeBadBlocknBits() const { return nSimpleMasternodeBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nSimpleMasternodeBadBlockTime;
    unsigned int nSimpleMasternodeBadBlocknBits;
