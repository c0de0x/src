...
// Copyright (c) 2016-2019 The SIMPLEMASTERNODE developers
...
public:
    ...
    static bool HasZcTxesIfNeeded(const TransactionRecord& record) {
        return (record.type == TransactionRecord::ZerocoinMint ||
                ...
                record.type == TransactionRecord::ZerocoinSpend_Change_zSMNC ||
...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeDelegated:
        return tr("Smnc Cold Stake");
    case TransactionRecord::StakeHot:
        return tr("Smnc Stake in behalf of");
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted Smnc to zSmnc");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zSmnc");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received Smnc from zSmnc");
    case TransactionRecord::ZerocoinSpend_Change_zSMNC:
        return tr("Minted Change as zSmnc from zSmnc Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zSmnc to Smnc");
    default:
        return QString();
    }
}
