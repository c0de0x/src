...
#include "qt/smnc/furabstractlistitemdelegate.h"
...
#include "config/smnc-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalSMNC = 0;
    qint64 totalZsmnc = 0;
    QList<qreal> valuesSMNC;
    QList<qreal> valueszSMNC;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(SIMPLEMASTERNODEGUI* _window);
    ~DashboardWidget();
