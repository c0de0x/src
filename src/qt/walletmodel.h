...
#ifndef SIMPLEMASTERNODE_QT_WALLETMODEL_H
#define SIMPLEMASTERNODE_QT_WALLETMODEL_H
...
/** Interface to SIMPLEMASTERNODE wallet from Qt view code. */
...
#endif // SIMPLEMASTERNODE_QT_WALLETMODEL_H
