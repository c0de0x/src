...
#include "qt/smnc/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/smnc/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(SIMPLEMASTERNODEGUI* _window, QWidget *parent) :
