...
#include "qt/smnc/sendmultirow.h"
#include "qt/smnc/coldstakingmodel.h"
#include "qt/smnc/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(SIMPLEMASTERNODEGUI* parent);
    ~ColdStakingWidget();
