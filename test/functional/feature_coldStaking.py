...
from test_framework.smnc_node import SimpleMasternodeTestNode
...
class SIMPLEMASTERNODE_ColdStakingTest(BitcoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(SimpleMasternodeTestNode())
...
if __name__ == '__main__':
    SIMPLEMASTERNODE_ColdStakingTest().main()
