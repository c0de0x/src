...
from fake_stake.base_test import SIMPLEMASTERNODE_FakeStakeTest

class zSmncwrappedSerialsTest(SIMPLEMASTERNODE_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zSmncs..." % DENOM_TO_USE)
