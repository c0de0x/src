...
The script [extract-osx-sdk.sh](https://github.com/SimpleMasternode/smnc/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
smnc/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/SimpleMasternode/smnc/blob/master/doc/README_osx.md) for troubleshooting tips.