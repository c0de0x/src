...
/** Interface from Qt to configuration data structure for SIMPLEMASTERNODE client.
...
public:
    ...
    enum OptionID {
        ...
        HideOrphans,    // bool
        AnonymizeSimpleMasternodeAmount, //int
...
signals:
    ...
    void anonymizeSimpleMasternodeAmountChanged(int);
