...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 39454;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // SIMPLEMASTERNODE starting difficulty is 1 / 2^12
        ...
        nLastPOWBlock = 250;
        nSimpleMasternodeBadBlockTime = 1471401614; // Skip nBit validation of Block 259201 per PR #915
        nSimpleMasternodeBadBlocknBits = 0x1c056dac; // Skip nBit validation of Block 259201 per PR #915
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "We love smnc";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1601553600;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 6199036;

        hashGenesisBlock = genesis.GetHash();
  
		assert(hashGenesisBlock == uint256("0x000009a172389e949c35c06ca8a016f28a92bcbc623e29495bc7671584343f21"));
        assert(genesis.hashMerkleRoot == uint256("0xba346af7d711799c47ba1fff7f1255038ff11f9ffb3cba57bf871d4ab324b64e"));
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 200;
        nSimpleMasternodeBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nSimpleMasternodeBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet smnc addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet smnc script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet smnc BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet smnc BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet smnc BIP44 coin type is '1' (All coin's testnet default)
        ...
        strObfuscationPoolDummyAddress = "smncfGRkekRyDRNeJiLtYVEbvhXrNbmox";
